...
public class LightingDevicesPage extends BasePage {
    ...
    @Override
    @Step("Проверка отображение объектов окна 'Приборы освещения'")
    ...
    public LampInstallationPage tapToLampInstallation() {
        lampInstallation.click();
        return openPage(buttonFurther, page, LampInstallationPage.class);
    }
}
